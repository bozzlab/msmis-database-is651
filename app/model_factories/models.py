...
class ExpenseCategoriesFactory(BaseFactory):
    ...
    name = factory.Iterator(["Food", "Transport", "Shopping", "Bills"])
...
class IncomeCategoriesFactory(BaseFactory):
    ...
    name = factory.Iterator(["Salary", "Bonus", "Freelance", "Investment"])
    user = factory.SubFactory(UsersFactory)
...
class UserGoalsFactory(BaseFactory):
    ...
    status = "PENDING" # factory.Iterator(["PENDING", "SUCCESS", "IN_PROGRESS", "FAILED"])
...
class ExpenseTransactionsFactory(BaseFactory):
    ...
    payment_method = factory.LazyFunction(lambda: get_random_existing(models.ExpensePaymentMethods))
...
class IncomeTransactionsFactory(BaseFactory):
    ...
    payment_method = factory.LazyFunction(lambda: get_random_existing(models.IncomePaymentMethods))
