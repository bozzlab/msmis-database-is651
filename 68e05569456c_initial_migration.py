...
Revision ID: 68e05569456c
Revises:
Create Date: 2025-11-06 11:54:10.074692
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("day BETWEEN 1 AND 31", name="valid_day_range"),
        sa.ForeignKeyConstraint(
    ...
    ## Trigger to update last_modified_at on update
    ...
    """)
    op.execute("""
       INSERT INTO income_payment_methods (name) VALUES 
        ('Cash'),
        ('Transfer'),
        ('Cheque');        
    """)
    ...
    """)
    op.execute("""
    INSERT INTO partners (id, name, is_active)
        VALUES
        (1, 'Kasikornbank Public Company Limited', 't'),
        (2, 'Siam Commercial Bank Public Company Limited', 't'),
        (3, 'Bangkok Bank Public Company Limited', 't'),
        (4, 'Bank of Ayudhya Public Company Limited', 't'),
        (5, 'TMBThanachart Bank Public Company Limited', 't'),
        (6, 'Government Savings Bank', 'f'),
        (7, 'Bangkok Life Assurance Public Company Limited', 't'),
        (8, 'Muang Thai Life Assurance Public Company Limited', 't'),
        (9, 'Thai Life Insurance Public Company Limited', 't'),
        (10, 'AIA Company Limited', 't'),
        (11, 'Viriyah Insurance Public Company Limited', 't'),
        (12, 'Syn Mun Kong Insurance Public Company Limited', 't'),
        (13, 'Dhipaya Insurance Public Company Limited', 't'),
        (14, 'Ocean Life Insurance Public Company Limited', 't'),
        (15, 'Tokio Marine Safety Insurance (Thailand) Public Company Limited', 't'),
        (16, 'Southeast Life Insurance Public Company Limited', 't'),
        (17, 'FWD Life Insurance Public Company Limited', 't'),
        (18, 'Thai Reinsurance Public Company Limited', 'f'),
        (19, 'Chubb Samaggi Insurance Public Company Limited', 't'),
        (20, 'LMG Insurance Public Company Limited', 'f');
    """)
    op.execute("""
        INSERT INTO partner_products (id, partner_id, type, remark, is_active) VALUES
        (1, 5, 'Credit Card', 'commission 15%', 't'),
        (2, 11, 'Travel Insurance', 'commission 20%', 'f'),
        (3, 2, 'Fixed Deposit Account', 'commission 10%', 't'),
        (4, 17, 'Health Insurance', 'commission 30%', 't'),
        (5, 9, 'Personal Accident Insurance', 'commission 15%', 'f'),
        (6, 1, 'Mutual Fund Investment', 'commission 20%', 't'),
        (7, 14, 'Travel Insurance', 'commission 10%', 't'),
        (8, 3, 'Car and Home Loan', 'commission 30%', 'f'),
        (9, 10, 'Health Insurance', 'commission 15%', 't'),
        (10, 7, 'Personal Accident Insurance', 'commission 20%', 't'),
        (11, 13, 'Travel Insurance', 'commission 10%', 'f'),
        (12, 4, 'Credit Card', 'commission 30%', 't'),
        (13, 12, 'Health Insurance', 'commission 15%', 't'),
        (14, 8, 'Travel Insurance', 'commission 20%', 'f'),
        (15, 16, 'Personal Accident Insurance', 'commission 10%', 't'),
        (16, 6, 'Fixed Deposit Account', 'commission 15%', 'f'),
        (17, 15, 'Health Insurance', 'commission 30%', 't'),
        (18, 2, 'Personal Loan', 'commission 20%', 't'),
        (19, 18, 'Travel Insurance', 'commission 10%', 'f'),
        (20, 1, 'Car and Home Loan', 'commission 15%', 't'),
        (21, 19, 'Health Insurance', 'commission 20%', 'f'),
        (22, 3, 'Mutual Fund Investment', 'commission 30%', 't'),
        (23, 20, 'Travel Insurance', 'commission 15%', 'f'),
        (24, 5, 'Fixed Deposit Account', 'commission 10%', 't'),
        (25, 11, 'Personal Accident Insurance', 'commission 20%', 't'),
        (26, 9, 'Health Insurance', 'commission 30%', 'f'),
        (27, 10, 'Travel Insurance', 'commission 15%', 't'),
        (28, 4, 'Personal Loan', 'commission 10%', 'f'),
        (29, 13, 'Health Insurance', 'commission 20%', 't'),
        (30, 8, 'Mutual Fund Investment', 'commission 30%', 't');
    """)
